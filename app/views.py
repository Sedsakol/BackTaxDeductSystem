            ...
            if "data" in content_data:
                ...
                while True :  
                    ...
                    if next_data_url :
                        ...
                        fc1 = facebook_categories.objects.filter(facebook_id = content_id, categories_version = 1).order_by('-created')[0]
                        fc1.data = json_obj_v1
                        fc1.save()

                        fc2 = facebook_categories.objects.get(facebook_id = content_id, categories_version = 2).order_by('-created')[0]
                        fc2.data = json_obj_v2
                        fc2.save()
